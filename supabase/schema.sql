...
create table if not exists public.profiles (
  ...
  last_map_lat double precision,
  last_map_lng double precision,
  last_map_at timestamptz,
  red_comunitaria_radius_km int not null default 25
...
-- Tokens FCM (push); ver migración 013 para índices/policies si ya existía la tabla.
