...
final alfabetizacionLecciones = <LeccionData>[
  ...
  const LeccionData(
    ...
    modulo: 'escritura',
    nivel: 1,
    titulo: 'Orden alfabético: trazos',
    contenido: 'A B C · D E F · M N Ñ',
    flujoId: kFlujoEscrituraTrazosOrdenAlfabeticoId,
    puntos: 10,
  ),
  const LeccionData(
    id: 'E1-6',
    modulo: 'escritura',
    nivel: 1,
    titulo: 'Orden alfabético: teclado',
    contenido: 'A B C · D E F · M N Ñ',
    flujoId: kFlujoEscrituraTecladoOrdenAlfabeticoId,
    puntos: 10,
  ),
  ...
  // --- Escritura nivel 3: frases (trazos → teclado, paralelo a lectura L4) ---
  const LeccionData(
    id: 'E3-1',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases cortas: trazos',
    contenido: 'MI MAMA ME AMA · MI PAPA RIEGA · LA VACA COME',
    flujoId: kFlujoEscrituraTrazosFrasesCortasId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-2',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases cortas: teclado',
    contenido: 'MI MAMA ME AMA · MI PAPA RIEGA · LA VACA COME',
    flujoId: kFlujoEscrituraTecladoFrasesCortasId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-3',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases de rutina agrícola 1: trazos',
    contenido: 'PAPA USA LA PALA · MAMA RIEGA EL MAIZ',
    flujoId: kFlujoEscrituraTrazosFrasesRutinaUnoId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-4',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases de rutina agrícola 1: teclado',
    contenido: 'PAPA USA LA PALA · MAMA RIEGA EL MAIZ',
    flujoId: kFlujoEscrituraTecladoFrasesRutinaUnoId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-5',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases de rutina agrícola 2: trazos',
    contenido: 'EL CAMPESINO CARGA SACO · LA FAMILIA VENDE MAIZ',
    flujoId: kFlujoEscrituraTrazosFrasesRutinaDosId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-6',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases de rutina agrícola 2: teclado',
    contenido: 'EL CAMPESINO CARGA SACO · LA FAMILIA VENDE MAIZ',
    flujoId: kFlujoEscrituraTecladoFrasesRutinaDosId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-7',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Construir frases en orden: trazos',
    contenido: 'MAMA RIEGA MAIZ · PAPA USA PALA · VACA TOMA AGUA',
    flujoId: kFlujoEscrituraTrazosFrasesOrdenId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-8',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Construir frases en orden: teclado',
    contenido: 'MAMA RIEGA MAIZ · PAPA USA PALA · VACA TOMA AGUA',
    flujoId: kFlujoEscrituraTecladoFrasesOrdenId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-9',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases con imagen: trazos',
    contenido: 'LA VACA TOMA AGUA · EL CAMPESINO SIEMBRA',
    flujoId: kFlujoEscrituraTrazosFrasesImagenId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-10',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Frases con imagen: teclado',
    contenido: 'LA VACA TOMA AGUA · EL CAMPESINO SIEMBRA',
    flujoId: kFlujoEscrituraTecladoFrasesImagenId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-11',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Mezcla de frases: trazos',
    contenido: 'MI PAPA RIEGA · LA VACA COME · MAMA USA PALA',
    flujoId: kFlujoEscrituraTrazosFrasesMezclaId,
    puntos: 25,
  ),
  const LeccionData(
    id: 'E3-12',
    modulo: 'escritura',
    nivel: 3,
    titulo: 'Mezcla de frases: teclado',
    contenido: 'MI PAPA RIEGA · LA VACA COME · MAMA USA PALA',
    flujoId: kFlujoEscrituraTecladoFrasesMezclaId,
    puntos: 25,
  ),
  // --- Escritura nivel 4: palabras (trazos → teclado, paralelo a lectura L3) ---
  const LeccionData(
    id: 'E4-1',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Palabras cortas: trazos',
    contenido: 'MAMA PAPA MESA PUMA',
    flujoId: kFlujoEscrituraTrazosPalabrasCortasId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-2',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Palabras cortas: teclado',
    contenido: 'MAMA PAPA MESA PUMA',
    flujoId: kFlujoEscrituraTecladoPalabrasCortasId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-3',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Palabras del campo: trazos',
    contenido: 'MAIZ PALA VACA RIEGO',
    flujoId: kFlujoEscrituraTrazosPalabrasCampoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-4',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Palabras del campo: teclado',
    contenido: 'MAIZ PALA VACA RIEGO',
    flujoId: kFlujoEscrituraTecladoPalabrasCampoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-5',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Asociación palabra-imagen 1: trazos',
    contenido: 'PALA MESA VACA',
    flujoId: kFlujoEscrituraTrazosPalabraImagenUnoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-6',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Asociación palabra-imagen 1: teclado',
    contenido: 'PALA MESA VACA',
    flujoId: kFlujoEscrituraTecladoPalabraImagenUnoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-7',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Asociación palabra-imagen 2: trazos',
    contenido: 'MAIZ RIEGO MULA',
    flujoId: kFlujoEscrituraTrazosPalabraImagenDosId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-8',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Asociación palabra-imagen 2: teclado',
    contenido: 'MAIZ RIEGO MULA',
    flujoId: kFlujoEscrituraTecladoPalabraImagenDosId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-9',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Completa palabras MA y PA: trazos',
    contenido: 'MAMA PAPA MAIZ',
    flujoId: kFlujoEscrituraTrazosCompletarPalabraUnoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-10',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Completa palabras MA y PA: teclado',
    contenido: 'MAMA PAPA MAIZ',
    flujoId: kFlujoEscrituraTecladoCompletarPalabraUnoId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-11',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Completa palabras LA y SA: trazos',
    contenido: 'LANA SACO LAMA',
    flujoId: kFlujoEscrituraTrazosCompletarPalabraDosId,
    puntos: 20,
  ),
  const LeccionData(
    id: 'E4-12',
    modulo: 'escritura',
    nivel: 4,
    titulo: 'Completa palabras LA y SA: teclado',
    contenido: 'LANA SACO LAMA',
    flujoId: kFlujoEscrituraTecladoCompletarPalabraDosId,
    puntos: 20,
  ),
  // --- Escritura nivel 5: comprensión y escritura contextual (paralelo a lectura L5) ---
  const LeccionData(
    id: 'E5-1',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión básica: trazos',
    contenido: 'EL CAMPESINO RIEGA MAIZ · LA VACA TOMA AGUA',
    flujoId: kFlujoEscrituraTrazosComprensionBasicaId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-2',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión básica: teclado',
    contenido: 'EL CAMPESINO RIEGA MAIZ · LA VACA TOMA AGUA',
    flujoId: kFlujoEscrituraTecladoComprensionBasicaId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-3',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión quién y qué: trazos',
    contenido: 'PAPA SIEMBRA MAIZ · MAMA VENDE QUESO',
    flujoId: kFlujoEscrituraTrazosComprensionQuienQueId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-4',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión quién y qué: teclado',
    contenido: 'PAPA SIEMBRA MAIZ · MAMA VENDE QUESO',
    flujoId: kFlujoEscrituraTecladoComprensionQuienQueId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-5',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión dónde: trazos',
    contenido: 'EL MAIZ ESTA EN LA CHACRA · LA VACA ESTA EN EL CORRAL',
    flujoId: kFlujoEscrituraTrazosComprensionDondeId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-6',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Comprensión dónde: teclado',
    contenido: 'EL MAIZ ESTA EN LA CHACRA · LA VACA ESTA EN EL CORRAL',
    flujoId: kFlujoEscrituraTecladoComprensionDondeId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-7',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Secuencia primero y después: trazos',
    contenido: 'PRIMERO SIEMBRA DESPUES RIEGA · PRIMERO COSECHA DESPUES VENDE',
    flujoId: kFlujoEscrituraTrazosSecuenciaBasicaId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-8',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Secuencia primero y después: teclado',
    contenido: 'PRIMERO SIEMBRA DESPUES RIEGA · PRIMERO COSECHA DESPUES VENDE',
    flujoId: kFlujoEscrituraTecladoSecuenciaBasicaId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-9',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Vocabulario contextual: trazos',
    contenido: 'COSECHA MERCADO SEMILLA SURCO',
    flujoId: kFlujoEscrituraTrazosVocabularioContextualId,
    puntos: 30,
  ),
  const LeccionData(
    id: 'E5-10',
    modulo: 'escritura',
    nivel: 5,
    titulo: 'Vocabulario contextual: teclado',
    contenido: 'COSECHA MERCADO SEMILLA SURCO',
    flujoId: kFlujoEscrituraTecladoVocabularioContextualId,
    puntos: 30,
  ),
];
